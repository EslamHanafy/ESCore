...
extension UIImageView {
    ...
    public func esSetImageForName(_ string: String, backgroundColor: UIColor? = nil, circular: Bool = true, textAttributes: [NSAttributedString.Key: AnyObject]? = nil, gradient: Bool = false) {
        
        self.image = esGetImageForName(string, backgroundColor: backgroundColor, circular: circular, textAttributes: textAttributes, gradient: gradient, gradientColors: nil)
    }
    
    public func esSetImageForName(_ string: String, gradientColors: GradientColors, circular: Bool = true, textAttributes: [NSAttributedString.Key: AnyObject]? = nil) {
        
        self.image = esGetImageForName(string, backgroundColor: nil, circular: circular, textAttributes: textAttributes, gradient: true, gradientColors: gradientColors)
    }
    
    public func esGetImageForName(_ string: String, backgroundColor: UIColor? = nil, circular: Bool = true, textAttributes: [NSAttributedString.Key: AnyObject]? = nil, gradient: Bool = false, gradientColors: GradientColors? = nil) -> UIImage {
        ...
        return imageSnapshot(text: initials, backgroundColor: color, circular: circular, textAttributes: attributes, gradient: gradient, gradientColors: gradientColors)
    }
