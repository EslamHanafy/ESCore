...
open class SecureTextToggleButton: UIButton {
    ...
    open var showSecureTextImage:UIImage = UIImage(named: "visibility_on", in: Bundle.core, compatibleWith: nil)!{
    ...
    open var hideSecureTextImage:UIImage = UIImage(named: "visibility_off", in: Bundle.core, compatibleWith: nil)!
    ...
    /**
     ...
     - returns:
     */
    public convenience init(showSecureTextImage:UIImage = UIImage(named: "visibility_on", in: Bundle.core, compatibleWith: nil)! , hideSecureTextImage:UIImage = UIImage(named: "visibility_off", in: Bundle.core, compatibleWith: nil)! , imageTint:UIColor = UIColor.gray)
    {
