...
public class EmailRule: RegexRule {
     ...
     */
    public convenience init(message : String = "Must be a valid email address",showMessage: Bool = true){
        self.init(regex: EmailRule.regex, message: message,showMessage:showMessage)
    }
}
