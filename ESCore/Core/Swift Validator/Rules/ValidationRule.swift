...
public class ValidationRule {
    ...
    public func validateField() -> ValidationError? {
        ...
        }.map{ rule -> ValidationError in return ValidationError(field: self.field, errorLabel:self.errorLabel, error: rule.errorMessage(), showErorMessage: rule.showMessage) }.first
    }
}
