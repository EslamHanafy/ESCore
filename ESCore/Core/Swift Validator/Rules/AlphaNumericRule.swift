...
public class AlphaNumericRule: CharacterSetRule {
     ...
     */
    public init(message: String = "Enter valid numeric characters",showMessage: Bool = true) {
        super.init(characterSet: CharacterSet.alphanumerics, message: message,showMessage: showMessage)
    }
}
