...
public class AlphaRule: CharacterSetRule {
     ...
     */
    public init(message: String = "Enter valid alphabetic characters",showMessage: Bool = true) {
        super.init(characterSet: CharacterSet.letters, message: message,showMessage:showMessage)
    }
}
