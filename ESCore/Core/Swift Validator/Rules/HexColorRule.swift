...
public class HexColorRule: RegexRule {
     ...
     */
    public init(message: String = "Invalid regular expression",showMessage: Bool = true) {
        super.init(regex: HexColorRule.regex, message: message,showMessage: showMessage)
    }
}
