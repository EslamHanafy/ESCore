...
public class PasswordRule : RegexRule {
     ...
     */
    public convenience init(message : String = "Must be 8 characters with 1 uppercase",showMessage: Bool = true) {
        self.init(regex: PasswordRule.regex, message : message,showMessage:showMessage)
    }
}
