...
public class ZipCodeRule: RegexRule {
     ...
     */
    public convenience init(message : String = "Enter a valid 5 or 9 digit zipcode",showMessage: Bool = true){
        self.init(regex: "\\d{5}(-\\d{4})?", message : message,showMessage:showMessage)
    }
}
