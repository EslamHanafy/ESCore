...
public class ValidationError: NSObject {
    ...
    public let showErorMessage: Bool
    /**
     ...
     */
    public init(field:ValidatableField, errorLabel:UILabel?, error:String,showErorMessage:Bool){
        self.field = field
        self.errorLabel = errorLabel
        self.errorMessage = error
        self.showErorMessage = showErorMessage
    }
}
