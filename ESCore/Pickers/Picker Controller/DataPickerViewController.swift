...
open class DataPickerViewController: UITableViewController {
    public var searchController: UISearchController?
    public var preferredSection: DataPickerPreferredSection?
    public var screenTitle: String = ""
    public var style: DataPickerStyle = DataPickerStyle()
    public var onSelectItem: ((_ item: DataPickerItemType) -> Void)?
    
    private var searchResults = [DataPickerItemType]()
    private var isSearchMode = false
    private var sectionsTitles = [String]()
    private var items = [String: [DataPickerItemType]]()
    private var selectedItem: DataPickerItemType?
    ...
    public init(with dataSource: DPDataSource, and style: DataPickerStyle = DataPickerStyle()) {
    ...
    open func selectedItem<T: DataPickerItemType>(type: T.Type, _ handler: @escaping (_ item: T) -> Void) {
...
//MARK: - Helpers
private extension DataPickerViewController {
    func prepareTableItems()  {
        self.tableView.register(DataPickerTableViewCell.self, forCellReuseIdentifier: "Cell")
...
extension DataPickerViewController {
    ...
    open override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! DataPickerTableViewCell
...
extension DataPickerViewController: UISearchResultsUpdating {
...
extension DataPickerViewController: UISearchControllerDelegate {
